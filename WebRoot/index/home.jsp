			...
			<div data-role="showList">
				<div class="list" style="display: block;">
					...
					<ul class="list-bigimg clearfix">
						<li onmouseover="mOver(this)" onmouseout="mOut(this)">
							<div class="list-infoBox">
								<a title="福特福克斯 2011款 福克斯-两厢 1.8 手动 舒适型" target="_blank"
									class="imgtype" href="/Car/index/detail.jsp"> <span class="hover-bg"></span> <img
									width="290" height="192"
									src="http://scs.ganjistatic1.com/gjfs16/M03/0C/B6/CgEHQlZeuWjGlaYNAA4Jb79IQvM791_290-192c_8-1.jpg"
									alt="福特福克斯 2011款 福克斯-两厢 1.8 手动 舒适型"> </a>
								<p class="infoBox">
									<a title="福特福克斯 2011款 福克斯-两厢 1.8 手动 舒适型"
										href="/sh/1868235952x.htm" target="_blank" class="info-title">福特福克斯
										2011款 福克斯-两厢 1.8 手动 舒适型</a>
								</p>
								<p class="fc-gray">
									<span class="">2011年7月上牌</span> <em class="shuxian">|</em>
									行驶5.5万公里
								</p>
								<p class="priType-s">
									<span><i class="fc-org priType">6.20</i>万</span> <s>12.50万</s>
								</p>
							</div></li>
